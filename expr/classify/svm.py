...
def prepare_trn_tst_pos_data():
  ...
  out_files = [
    ...
    # os.path.join(root_dir, 'expr', 'twostream', 'dev08.vlad.8.pos.npz'),
    # os.path.join(root_dir, 'expr', 'twostream', 'eev08.vlad.8.pos.npz')
  ]
...
def prepare_trn_tst_neg_data():
  ...
  out_files = [
    ...
    # os.path.join(root_dir, 'expr', 'twostream', 'dev08.vlad.16.neg.5.npz'),
    # os.path.join(root_dir, 'expr', 'twostream', 'eev08.vlad.16.neg.5.npz')
    os.path.join(root_dir, 'expr', 'twostream', 'dev08.vlad.8.neg.5.npz'),
    os.path.join(root_dir, 'expr', 'twostream', 'eev08.vlad.8.neg.5.npz')
  ]
  # ft_dir = os.path.join(root_dir, 'c3d', 'vlad')
  # ft_dir = os.path.join(root_dir, 'vgg19_pool5_fullres', 'vlad')
  # ft_dir = os.path.join(root_dir, 'twostream', 'feat_anet_flow_6frame', 'vlad')
...
def prepare_pos_data_with_tracklen_fixed():
  ...
  track_len = 25
  # track_len = 50
  # out_file = os.path.join(root_dir, 'expr', 'c3d', 'eev08.vlad.16.pos.%d.npz'%track_len)
  out_file = os.path.join(root_dir, 'expr', 'c3d', 'dev08.vlad.16.pos.%d.npz'%track_len)
  ft_dir = os.path.join(root_dir, 'c3d', 'vlad.16')
  ...
  # ft_dir = os.path.join(root_dir, 'twostream', 'feat_anet_flow_6frame', 'vlad.16')
  # out_file = os.path.join(root_dir, 'expr', 'twostream', 'eev08.vlad.16.pos.%d.npz'%track_len)
  # ft_dir = os.path.join(root_dir, 'twostream', 'feat_anet_flow_6frame', 'vlad.16')
  # out_file = os.path.join(root_dir, 'expr', 'twostream', 'dev08.vlad.8.pos.%d.npz'%track_len)
  # ft_dir = os.path.join(root_dir, 'twostream', 'feat_anet_flow_6frame', 'vlad.8')
  # out_file = os.path.join(root_dir, 'expr', 'twostream', 'eev08.vlad.8.pos.%d.npz'%track_len)
  # ft_dir = os.path.join(root_dir, 'twostream', 'feat_anet_flow_6frame', 'vlad.8')
...
def prepare_neg_data_with_tracklen_fixed():
  ...
  track_len = 25
  # track_len = 50
  # out_file = os.path.join(root_dir, 'expr', 'c3d', 'eev08.vlad.16.neg.5.%d.npz'%track_len)
  out_file = os.path.join(root_dir, 'expr', 'c3d', 'dev08.vlad.16.neg.5.%d.npz'%track_len)
  ft_dir = os.path.join(root_dir, 'c3d', 'vlad.16')
  ...
  # ft_dir = os.path.join(root_dir, 'twostream', 'feat_anet_flow_6frame', 'vlad.16')
  # out_file = os.path.join(root_dir, 'expr', 'twostream', 'eev08.vlad.16.neg.5.%d.npz'%track_len)
  # ft_dir = os.path.join(root_dir, 'twostream', 'feat_anet_flow_6frame', 'vlad.16')
  # out_file = os.path.join(root_dir, 'expr', 'twostream', 'dev08.vlad.8.neg.5.%d.npz'%track_len)
  # ft_dir = os.path.join(root_dir, 'twostream', 'feat_anet_flow_6frame', 'vlad.8')
  # out_file = os.path.join(root_dir, 'expr', 'twostream', 'eev08.vlad.8.neg.5.%d.npz'%track_len)
  # ft_dir = os.path.join(root_dir, 'twostream', 'feat_anet_flow_6frame', 'vlad.8')
...
def prepare_trn_data():
  ...
  # pos_trn_file = os.path.join(root_dir, 'expr', 'twostream', 'dev08.vlad.8.pos.npz')
  # neg_trn_file = os.path.join(root_dir, 'expr', 'twostream', 'dev08.vlad.8.neg.5.npz')
  # out_file = os.path.join(root_dir, 'expr', 'twostream', 'dev08.vlad.8.npz')
  ...
  # pos_trn_file = os.path.join(root_dir, 'expr', 'c3d', 'dev08.vlad.pos.25.npz')
  # neg_trn_file = os.path.join(root_dir, 'expr', 'c3d', 'dev08.vlad.neg.5.25.npz')
  # out_file = os.path.join(root_dir, 'expr', 'c3d', 'dev08.25.vlad.npz')
  pos_trn_file = os.path.join(root_dir, 'expr', 'c3d', 'dev08.vlad.16.pos.25.npz')
  neg_trn_file = os.path.join(root_dir, 'expr', 'c3d', 'dev08.vlad.16.neg.5.25.npz')
  out_file = os.path.join(root_dir, 'expr', 'c3d', 'dev08.25.vlad.16.npz')
...
def train_model():
  ...
  # out_file = os.path.join(root_dir, 'expr', 'twostream', 'svm.cell2ear.refine.CellToEar.Embrace.Pointing.PersonRuns.pkl')
  ...
  trn_file = os.path.join(root_dir, 'expr', 'c3d', 'dev08.25.vlad.16.npz')
  out_file = os.path.join(root_dir, 'expr', 'c3d', 'svm.16.CellToEar.Embrace.Pointing.PersonRuns.25.pkl')
  ...
  # trn_file = os.path.join(root_dir, 'expr', 'twostream', 'dev08.vlad.8.npz')
  # out_file = os.path.join(root_dir, 'expr', 'twostream', 'svm.8.CellToEar.Embrace.Pointing.PersonRuns.pkl')
  # trn_file = os.path.join(root_dir, 'expr', 'twostream', 'dev08.25.vlad.npz')
...
def val_model():
  ...
  # pos_val_file = os.path.join(root_dir, 'expr', 'twostream', 'eev08.vlad.16.pos.npz')
  # neg_val_file = os.path.join(root_dir, 'expr', 'twostream', 'eev08.vlad.16.neg.5.npz')
  # pos_val_file = os.path.join(root_dir, 'expr', 'twostream', 'eev08.vlad.8.pos.npz')
  ...
  # pos_val_file = os.path.join(root_dir, 'expr', 'c3d', 'eev08.vlad.pos.25.npz')
  # neg_val_file = os.path.join(root_dir, 'expr', 'c3d', 'eev08.vlad.neg.5.25.npz')
  pos_val_file = os.path.join(root_dir, 'expr', 'c3d', 'eev08.vlad.16.pos.25.npz')
  neg_val_file = os.path.join(root_dir, 'expr', 'c3d', 'eev08.vlad.16.neg.5.25.npz')
  ...
  model_file = os.path.join(root_dir, 'expr', 'c3d', 'svm.16.CellToEar.Embrace.Pointing.PersonRuns.25.pkl')
...
def eval_full():
  ...
  for videoname in videonames:
    ...
    predict_file = os.path.join(predict_dir, videoname + '.dev08.liblinear.raw.npz')
